...
- **Series-name normalisation in sort**: `episodes-loader.ts` uses a slugified comparison key when grouping series within a year, so "The French Revolution" and "French Revolution" cluster together regardless of LLM consistency.
