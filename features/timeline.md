...
- **Series badge**: when an episode has a `series` field from the classifier, a small uppercase badge appears above the title ("The French Revolution · Part 2 of 5"). This is the v1 visual signal for series grouping; cross-year visual connectors for parts at different timeline positions are a later polish.
